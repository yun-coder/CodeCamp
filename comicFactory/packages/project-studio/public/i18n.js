...
const DICT = {
  en: {
    ...
    'modal.new.name_placeholder': 'e.g.  launch teaser',
    ...
    'settings.audio.hint': 'Stored locally in .video-pipeline/media-config.json. Leave Base URL empty unless your key is for api.minimax.io.',
    ...
    'settings.about.subtitle': 'video-pipeline — open-source HTML→Video meta-layer for coding agents.',
  ...
  zh: {
    ...
    'settings.audio.hint': '保存在本地 .video-pipeline/media-config.json。Base URL 留空即可，除非你的 key 是 api.minimax.io 的。',
    ...
    'settings.about.subtitle': 'video-pipeline — 开源的 HTML→视频 meta-layer，为 coding agent 设计。',
