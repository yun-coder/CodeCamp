...
import { CanvasDesigner } from '@/utils/canvasDesigner';
import LeftSidebar from '@/components/designer/LeftSidebar.vue';
...
import RulerCanvas from '@/components/designer/RulerCanvas.vue';
