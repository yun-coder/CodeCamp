/**
 * studio frontend types for the comic book editor.
 * Mirrors src/ir/comic.ts (server IR) and src/server/project-types.ts
 * (server Project). The client never imports from those server files —
 * this file is a hand-rolled mirror so the UI bundle stays free of Node-only
 * imports.
 */
...
/** Mirror of server-side Project type. */
